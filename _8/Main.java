...
public class Main {
    ...
    private static void exercise1() {
        ...
        ourNumberAsInt+=2;
        String numberConverted = String.valueOf(ourNumberAsInt);
        System.out.println(ourNumberAsInt);
    }
    ...
    private static void exercise3() {
        ...
        String doubleStrToConvert = "4.4"; // Also this line
    ...
    private static void exercise4() {
        ...
        startInt*=2;
        String startStringAgain=String.valueOf(startInt);
        startStringAgain+=startStringAgain;
        double startDouble= Double.valueOf(startStringAgain);
        startDouble= startDouble/3.5;
