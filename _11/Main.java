...
public class Main {
    ...
    public static void exercise2() {
        ...
        switch (inputNumber) {
            case 1 -> System.out.println("this is the smallest prime number under 20");

            case 3 ->
                    System.out.println("this is the second smallest prime number under 20");
            case 5 ->
                    System.out.println("this is the 3th smallest prime number under 20");

            case 7 ->
                    System.out.println("this is the 4th smallest prime number under 20");

            case 9 ->
                    System.out.println("this is the 5th smallest prime number under 20");

            case 11 ->
                    System.out.println("this is the first smallest prime number up 10");

            case 13 ->
                    System.out.println("this is the 2nd smallest prime number up 10");

            case 15 ->
                    System.out.println("this is the 3th smallest prime number up 10");

            case 17 ->
                    System.out.println("this is the 4th smallest prime number up 10");

            case 19 ->
                    System.out.println("this is the 5th smallest prime number up 10");
            default ->
