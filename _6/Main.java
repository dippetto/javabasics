...
public class Main {
    ...
    private static void exercise1() {
       ...
       double value=25;
       double valueSquareRoot=0;
       valueSquareRoot=Math.sqrt(value);
       System.out.println("The root of value is = "+valueSquareRoot);
