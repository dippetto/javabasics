...
exercise3();
    ...
    private static void exercise3() {
        System.out.println("\nExercise 3:");
        //Giving to hasEatenLunch the boolean type
        boolean hasEatenLunch = false;
        //Giving to lunchCost the amount of the lunch cost in double type
        double lunchCost = 5.99;
        //Printing out the lunch cost and if I've eaten lunch in boolean type
