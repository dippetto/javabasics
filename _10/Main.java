...
public class Main {
    ...
    private static void exercise3() {
        ...
        double ourTestScore = 6;
        double maxTestScore = 10;
        boolean isTestRetry = true;
        double testPercentage=(ourTestScore*100)/maxTestScore;
        testPercentage=Math.floor(testPercentage);
        if (isTestRetry){
        if (testPercentage >= 70) {
            System.out.println("C");
        } else if (testPercentage>=60) {
