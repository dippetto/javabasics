...
public class Main {
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1:");
       String myName="Roberto Tancredi";
    ...
    private static void exercise2() {
        ...
        String middleName = "pio";
        String lastName = "Tancredi";
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives = ""+34+true; // <--- Edit this line
    ...
    private static void exercise4() {
        ...
        System.out.println(earlyNumbers+middleNumbers+endNumbers); // <--- Write your code here
    }
